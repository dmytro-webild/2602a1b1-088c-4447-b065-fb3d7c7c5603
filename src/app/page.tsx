...
export default function LandingPage() {
  ...
  <div id="home" data-section="home">
      ...
      testimonials={[
        ...
        },
        {
          name: "Sara Khan",
          handle: "@sara",
          testimonial: "Obsessed with their minimal design aesthetic.",
          rating: 5,
      ...
      avatars={[
        ...
        {
          src: "http://img.b2bpic.net/free-photo/caucasian-punk-female-with-attitude-outdoors_23-2149111015.jpg",
          alt: "Customer 2",
        },
        {
        ...
        {
          src: "http://img.b2bpic.net/free-photo/handsome-stylish-spanish-man-posing-red-wall-background-sunny-day_181624-54408.jpg",
          alt: "Customer 5",
        },
      ]}
      marqueeItems={[
  ...
  <div id="about" data-section="about">
      ...
      title="Our Vision"
      description={[
        "Offset Official was born from a desire to bring bold, minimal streetwear to the streets of Pakistan.",
        "We believe in quality over quantity, offering custom designs that speak for themselves.",
      ]}
    />
  </div>
  ...
  <div id="products" data-section="products">
      ...
      products={[
        ...
        },
        {
          ...
          price: "PKR 3,500",
          variant: "Grey",
          imageSrc: "http://img.b2bpic.net/free-photo/portrait-young-female-jumping_23-2148925642.jpg",
        },
        {
          id: "p5",
          name: "Logo Cap",
      ...
      features={[
        {
          ...
          subtitle: "Delivering across all cities in Pakistan.",
          category: "Logistics",
          value: "100%",
        },
        {
          ...
          subtitle: "Get personalized graphics tailored to your taste.",
          category: "Design",
          value: "Personalized",
        },
        {
          ...
          subtitle: "High-quality fabrics designed to last.",
          category: "Quality",
          value: "Premium",
        },
      ]}
      ...
      faqs={[
        {
          ...
          content: "You can DM us or message us on WhatsApp to place your order.",
        },
        {
          id: "q2",
          title: "Do you deliver nationwide?",
          content: "Yes, we deliver all over Pakistan.",
        },
        {
          id: "q3",
          title: "Can I request custom designs?",
          content: "Absolutely! Reach out to us via DM or WhatsApp to discuss your idea.",
        },
      ]}
      ...
      buttons={[
        {
          ...
          href: "https://wa.me/message/3ET5TYJ5RD7NF1",
        },
      ]}
    />
  </div>
